...
/***/ (function(module, exports, __webpack_require__) {
	...
	var preLoadHide = __webpack_require__(44);
	var blogpostEvents = __webpack_require__(13);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://ancient-forest-15685.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hideAboutShowSignin = function hideAboutShowSignin() {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var submitEditButtonTemplate = __webpack_require__(36);
	var getFormFields = __webpack_require__(9);

	var onDeleteBlog = function onDeleteBlog(event) {
	  event.preventDefault();
	  var id = $(this).attr('data-id');
	  api.deleteBlog(id).then(ui.deleteBlogSuccess).then(function () {
	    $('.one-blogpost[data-id=' + id + ']').parent().hide('blind');
	    $('blockquote[data-id=' + id + ']').hide('blind');
	  }).then(function () {
	    var numOfBlogs = $('.blogpost-content').children().length;
	...
	var onSubmitEdit = function onSubmitEdit(event) {
	  event.preventDefault();
	  var blogpostTitle = $(this).parent().find('h2')[0].innerHTML;
	  var blogpostContent = $(this).parent().find('p')[0].innerHTML;
	  var id = $(this).prev().attr('data-id');
	  var strippedBlogContent = blogpostContent.replace(/(<([^>]+)>)/ig, '');
	  var strippedBlogTitle = blogpostTitle.replace(/(<([^>]+)>)/ig, '');
	  var data = {
	    'blogpost': {
	  ...
	  api.editBlog(data, id).then(ui.editBlogSuccess).then(function () {
	...
	var onEditBlog = function onEditBlog(event) {
	  ...
	  var submitEditButtonHtml = submitEditButtonTemplate({});
	...
	var onGetBlogpost = function onGetBlogpost() {
	  api.getBlogposts().then(ui.getBlogpostsSuccess).then(function () {
	    $('.blog-delete-button').on('click', onDeleteBlog);
	    $('.blog-edit-button').on('click', onEditBlog);
	  }).catch(ui.getBlogPostFailure);
	};

	var onSubmitCreateBlog = function onSubmitCreateBlog(event) {
	  event.preventDefault();
	  var data = getFormFields(this);
	  // console.log(data)
	  api.submitCreateBlog(data).then(ui.submitCreateBlogSuccess).then(api.getBlogposts).then(ui.getBlogpostsSuccess).then(function () {
	    $('.blog-delete-button').on('click', onDeleteBlog);
	    $('.blog-edit-button').on('click', onEditBlog);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var editBlog = function editBlog(data, id) {
	  return $.ajax({
	    url: config.apiOrigin + '/blogposts/' + id,
	    method: 'PATCH',
	    headers: {
	...
	var submitCreateBlog = function submitCreateBlog(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/blogposts',
	    method: 'POST',
	    headers: {
	...
	module.exports = {
	  ...
	  editBlog: editBlog,
	  submitCreateBlog: submitCreateBlog
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showBlogpostsTemplate = __webpack_require__(16);

	var getBlogpostsSuccess = function getBlogpostsSuccess(data) {
	  if (data.blogposts.length < 1) {
	    $('.blogpost-content').append('<h1>No Blogs</h1>');
	  } else {
	    var showBlogpostsHtml = showBlogpostsTemplate({ blogposts: data.blogposts });
	    $('.blogpost-content').append(showBlogpostsHtml);
	    // console.log('inside getBlogpostsSuccess ', data)
	  }
	};

	var getBlogpostsFailure = function getBlogpostsFailure(error) {
	  console.error(error);
	...
	var deleteBlogFailure = function deleteBlogFailure(error) {
	  console.error(error);
	...
	var editBlogFailure = function editBlogFailure(error) {
	  // console.log('delete blog did not work and error is ', error)
	  console.error(error);
	};

	var submitCreateBlogSuccess = function submitCreateBlogSuccess(data) {
	  // console.log('create blog post success and data is ', data)
	  $('#create-modal').modal('hide');
	  $('.blogpost-content').empty();
	};

	var submitCreateBlogFailure = function submitCreateBlogFailure(error) {
	  // console.log('create blog did not work and error is ', error)
	  console.error(error);
	};

	module.exports = {
	  getBlogpostsSuccess: getBlogpostsSuccess,
	  getBlogpostsFailure: getBlogpostsFailure,
	  deleteBlogSuccess: deleteBlogSuccess,
	  deleteBlogFailure: deleteBlogFailure,
	  editBlogSuccess: editBlogSuccess,
	  editBlogFailure: editBlogFailure,
	  submitCreateBlogSuccess: submitCreateBlogSuccess,
	  submitCreateBlogFailure: submitCreateBlogFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n\n<blockquote data-id=\""
	    ...
	    + "\">\n<div class='blogpost-container' data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n  <div data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class='one-blogpost'>\n    <div>\n      <h2 data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.blogpostTitle : stack1), depth0))
	    + "</h2>\n    </div>\n    <div>\n      <p data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.blogpostContent : stack1), depth0))
	    + "</p>\n    </div>\n    <div>\n        "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.created_at : stack1), depth0))
	    + "\n    </div>\n  </div>\n  <button type=\"button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class='btn btn-default blog-edit-button'>Edit Blog</button>\n  <button type=\"button\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class='btn btn-danger blog-delete-button'>Delete Blog</button>\n</div>\n</blockquote>\n\n\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<button id='submit-edit' type='button' class= 'btn btn-success'>Submit</button>\n<button id='cancel-edit' type='button' class= 'btn btn-primary'>Cancel</button>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onGetPages = function onGetPages() {
	  api.getPages().then(ui.getPagesSuccess).catch(ui.getPagesFailure);
	};

	var showTemplate1 = function showTemplate1(event) {
	  event.preventDefault();
	...
	var showTemplate2 = function showTemplate2(event) {
	  event.preventDefault();
	...
	var scrapeHtml = function scrapeHtml(event) {
	  event.preventDefault();
	  var data = {};
	  data.page = {};
	  data.page.templateType = 1;
	  var pageTitle = $('#create-page-1-title').val();
	  data.page.pageTitle = pageTitle;
	  var header = $('#template-1-header').text();
	  // console.log('header is ', header)
	  // strip html tags from text - safety against injection
	  var strippedHeader = header.replace(/(<([^>]+)>)/ig, '');
	  data.page.header = strippedHeader;
	  var subHeader = $('#template-1-sub-header').text();
	  // strip html tags from text - safety against injection
	  var strippedSubHeader = subHeader.replace(/(<([^>]+)>)/ig, '');
	  data.page.subHeader = strippedSubHeader;
	  var pageContent = $('#template-1-about').text();
	  // strip html tags from text - safety against injection
	  var strippedPageContent = pageContent.replace(/(<([^>]+)>)/ig, '');
	  data.page.pageContent = strippedPageContent;
	  var contact = $('#template-1-email').text();
	  // strip html tags from text - safety against injection
	  var strippedContact = contact.replace(/(<([^>]+)>)/ig, '');
	...
	var scrapeHtml2 = function scrapeHtml2(event) {
	  event.preventDefault();
	  var data = {};
	  data.page = {};
	  data.page.templateType = 2;
	  var pageTitle = $('#create-page-2-title').val();
	  data.page.pageTitle = pageTitle;
	  var header = $('#template-2-header').text();
	  // console.log('header is ', header)
	  // strip html tags from text - safety against injection
	  var strippedHeader = header.replace(/(<([^>]+)>)/ig, '');
	  data.page.header = strippedHeader;
	  var subHeader = $('#template-2-sub-header').text();
	  // strip html tags from text - safety against injection
	  var strippedSubHeader = subHeader.replace(/(<([^>]+)>)/ig, '');
	  data.page.subHeader = strippedSubHeader;
	  var pageContent = $('#template-2-about').text();
	  // strip html tags from text - safety against injection
	  var strippedPageContent = pageContent.replace(/(<([^>]+)>)/ig, '');
	  data.page.pageContent = strippedPageContent;
	  var pageContentMore = $('#template-2-more').text();
	  // strip html tags from text - safety against injection
	  var strippedPageContentMore = pageContentMore.replace(/(<([^>]+)>)/ig, '');
	  data.page.pageContentMore = strippedPageContentMore;

	  // Bug fix for pageContentMore Column 1
	  var columnHeader1 = $('#template-header').text();
	  // strip html tags from text - safety against injection
	  var strippedColumnHeader1 = columnHeader1.replace(/(<([^>]+)>)/ig, '');
	  data.page.columnHeader1 = strippedColumnHeader1;

	  // Bug fix for pageContentMore Column 2
	  var columnHeader2 = $('#template-header-2').text();
	  // strip html tags from text - safety against injection
	  var strippedColumnHeader2 = columnHeader2.replace(/(<([^>]+)>)/ig, '');
	  data.page.columnHeader2 = strippedColumnHeader2;

	  var contact = $('#template-2-email').text();
	  // strip html tags from text - safety against injection
	  var strippedContact = contact.replace(/(<([^>]+)>)/ig, '');
	  data.page.contact = strippedContact;
	  api.createPage(data).then(ui.createPageSuccess).catch(ui.createPageFailure);
	...
	var resetTemplate1Fields = function resetTemplate1Fields() {
	...
	var hideTemplate1 = function hideTemplate1(event) {
	  event.preventDefault();
	...
	var resetTemplate2Fields = function resetTemplate2Fields() {
	...
	var hideTemplate2 = function hideTemplate2(event) {
	  event.preventDefault();
	...
	var hideTemplate1Edit = function hideTemplate1Edit(event) {
	  event.preventDefault();
	...
	var hideTemplate2Edit = function hideTemplate2Edit(event) {
	  event.preventDefault();
	  $('#edit-container').remove();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var config = __webpack_require__(6);
	var store = __webpack_require__(11);
	var pageStore = __webpack_require__(39);

	// Pulls pages for current user on authentication
	var getPages = function getPages(data) {
	  return $.ajax({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var displaySinglePageTemplate = __webpack_require__(41);
	var displaySinglePageTemplate2 = __webpack_require__(42);
	var pageDisplayer = __webpack_require__(43);
	...
	var getPagesSuccess = function getPagesSuccess(data) {
	  ...
	  if (data.pages.length < 1) {
	    ...
	    var pageShower = pageDisplayer({ pages: data.pages });
	    $('.page-content').append(pageShower);
	    $('.madePage').on('click', onGetPage);
	  }
	};

	var onGetPage = function onGetPage(event) {
	  event.preventDefault();
	  var id = $(this).data('id');
	  // console.log('Simon says This ID is', $(this).data('id'))
	  api.getPage(id).then(getPageSuccess).catch(getPageFailure);
	};

	var getPagesFailure = function getPagesFailure(error) {
	...
	var createPageSuccess = function createPageSuccess(data) {
	  ...
	  $('#submit-template-2-button').prop('disabled', true);
	  $('.page-content').empty();
	  api.getPages(data).then(getPagesSuccess).catch(getPagesSuccess);
	};
	...
	var onEditPage = function onEditPage(event) {
	  ...
	  var tempStyle = pageStore.templateType;
	  if (tempStyle === 1) {
	    scrapeHtml();
	  } else {
	    scrapeHtml2();
	...
	var getPageSuccess = function getPageSuccess(data) {
	  // console.log('data is ', data)
	  ...
	  var pageStoreId = data.page.id;
	  pageStore.id = pageStoreId;

	  var templateType = data.page.templateType;
	  pageStore.templateType = templateType;
	  // console.log('PAGESTORE TEMP TYPE IS', pageStore.templateType)
	};

	var showPageHtml = function showPageHtml(data) {
	  // console.log('SIMON SAYS DATA IS ', data)
	  if (data.page.templateType === 1) {
	    var pageRenderT1 = displaySinglePageTemplate({ page: data.page });
	    ...
	    var pageRenderT2 = displaySinglePageTemplate2({ page: data.page });
	    $('#page-2-template-edit').append(pageRenderT2);
	    $('#edit-page-2-title').val(data.page.pageTitle);
	  }
	};

	var getPageFailure = function getPageFailure(error) {
	  console.error('ERROR ', error);
	};
	...
	// Scrapes data for Page Template 1
	var scrapeHtml = function scrapeHtml() {
	  var data = {};
	  data.page = {};
	  data.page.templateType = 1;
	  var pageTitle = $('#edit-page-1-title').val();
	  data.page.pageTitle = pageTitle;
	  var header = $('#modal1-edit-header').text();
	  // console.log('header is ', header)
	  // strip html tags from text - safety against injection
	  // const strippedHeader = header.replace(/(<([^>]+)>)/ig, '')
	  data.page.header = header;
	  var subHeader = $('#modal1-edit-subheader').text();
	  // strip html tags from text - safety against injection
	  var strippedSubHeader = subHeader.replace(/(<([^>]+)>)/ig, '');
	  data.page.subHeader = strippedSubHeader;
	  var pageContent = $('#modal1-edit-about').text();
	  // strip html tags from text - safety against injection
	  var strippedPageContent = pageContent.replace(/(<([^>]+)>)/ig, '');
	  data.page.pageContent = strippedPageContent;
	  var contact = $('#modal1-edit-contact').text();
	  // strip html tags from text - safety against injection
	  var strippedContact = contact.replace(/(<([^>]+)>)/ig, '');
	  data.page.contact = strippedContact;
	  // console.log('WHAT AM I?', data)
	  api.editPage(data).then(updateSuccess).catch(updateFailure);
	  pageStore.id = null;
	...
	// Scraptes data for Page Template 2
	var scrapeHtml2 = function scrapeHtml2() {
	  var data = {};
	  data.page = {};
	  data.page.templateType = 2;
	  var pageTitle = $('#edit-page-2-title').val();
	  data.page.pageTitle = pageTitle;
	  var header = $('#modal2-edit-header').text();
	  // console.log('header is ', header)
	  // strip html tags from text - safety against injection
	  var strippedHeader = header.replace(/(<([^>]+)>)/ig, '');
	  data.page.header = strippedHeader;
	  var subHeader = $('#modal2-edit-subheader').text();
	  // strip html tags from text - safety against injection
	  var strippedSubHeader = subHeader.replace(/(<([^>]+)>)/ig, '');
	  data.page.subHeader = strippedSubHeader;
	  var pageContent = $('#modal2-edit-about').text();
	  // strip html tags from text - safety against injection
	  var strippedPageContent = pageContent.replace(/(<([^>]+)>)/ig, '');
	  data.page.pageContent = strippedPageContent;
	  var pageContentMore = $('#modal2-edit-more').text();
	  // strip html tags from text - safety against injection
	  var strippedPageContentMore = pageContentMore.replace(/(<([^>]+)>)/ig, '');
	  data.page.pageContentMore = strippedPageContentMore;

	  // Bug fix for pageContentMore Column 1
	  var columnHeader1 = $('#modal2-edit-column-header1').text();
	  // strip html tags from text - safety against injection
	  var strippedColumnHeader1 = columnHeader1.replace(/(<([^>]+)>)/ig, '');
	  data.page.columnHeader1 = strippedColumnHeader1;

	  // Bug fix for pageContentMore Column 2
	  var columnHeader2 = $('#modal2-edit-column-header2').text();
	  // strip html tags from text - safety against injection
	  var strippedColumnHeader2 = columnHeader2.replace(/(<([^>]+)>)/ig, '');
	  data.page.columnHeader2 = strippedColumnHeader2;

	  var contact = $('#modal2-edit-contact').text();
	  // strip html tags from text - safety against injection
	  var strippedContact = contact.replace(/(<([^>]+)>)/ig, '');
	  data.page.contact = strippedContact;
	  // console.log('WHAT AM I?', data)
	...
	var onDestroyPage = function onDestroyPage(event) {
	  event.preventDefault();
	  var id = pageStore.id;
	  api.destroyPage(id).then(destroySuccess).catch(destroyFailure);
	  pageStore.id = null;
	  pageStore.templateType = null;
	  $('#page-1-template-edit, #page-2-template-edit').empty();
	};

	var destroySuccess = function destroySuccess(data) {
	  // console.log(data)
	  $('.page-content').empty();
	  $('#delete-template-1-edit-button').off();
	  $('#delete-template-2-edit-button').off();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div id=\"edit-container\">\n\n  <div id=\"modal1-edit-header\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.header : stack1), depth0))
	    + "</div>\n\n  <div id=\"modal1-edit-subheader\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.subHeader : stack1), depth0))
	    + "</div>\n\n  <div id=\"modal1-edit-about\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.pageContent : stack1), depth0))
	    + "</div>\n\n  <div id=\"modal1-edit-footer\">\n    <i class=\"fa fa-envelope\" aria-hidden=\"true\"></i>\n    <div id=\"modal1-edit-contact\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.contact : stack1), depth0))
	    + "</div>\n  </div>\n  </div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <div id=\"edit-container\">\n\n  <div id=\"modal2-edit-header\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.header : stack1), depth0))
	    + "</div>\n\n  <div id=\"modal2-edit-subheader\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.subHeader : stack1), depth0))
	    + "</div>\n\n  <div class=\"row\">\n    <div id=\"modal2-edit-column-header1\" class=\"col-xs-6\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.columnHeader1 : stack1), depth0))
	    + "</div>\n\n      <div id=\"modal2-edit-column-header2\" class=\"col-xs-6\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.columnHeader2 : stack1), depth0))
	    + "</div>\n  </div> <!-- End of row div. -->\n\n  <div class=\"row\">\n    <div id=\"modal2-edit-about\" class=\"col-xs-6\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.pageContent : stack1), depth0))
	    + "</div>\n\n      <div id=\"modal2-edit-more\" class=\"col-xs-6\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.pageContentMore : stack1), depth0))
	    + "</div>\n  </div> <!-- End of row div. -->\n\n  <div id=\"modal2-edit-footer\">\n    <i class=\"fa fa-envelope\" aria-hidden=\"true\"></i>\n    <div id=\"modal2-edit-contact\" contenteditable=\"true\">"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.page : depth0)) != null ? stack1.contact : stack1), depth0))
	    + "</div>\n  </div>\n  </div>\n";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"madePage\" type=\"submit\" name=\"submit\">\n\n    "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.pageTitle : stack1), depth0))
	    + "\n\n  </button> <!-- End data-id btn -->\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "a21ae6c29fbf9b52b20616944a6c5d5d.jpg";

/***/ }),
/* 54 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "02ec677850fde640cadd30c133a97851.jpg";

/***/ }),
/* 55 */
/***/ (function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "cfb2de6075dd981e5958b6d4b5484714.jpg";
